...
import static com.zhytnik.benchmark.test.ConversionExtension.*;
import static com.zhytnik.benchmark.test.Resources.loadByType;
...
public abstract class ConverterTest {
    ...
    InputStream document = loadByType(getType());
